  ...
  data() {
    return {
      ...
      options: {
        ...
        customBackend: {
          "arick提供-后端": "https://apisub.arick.top",
        },
        backendOptions: [
          { value: "https://apisub.arick.top" },
        ],
        remoteConfig: [
          {
            label: "CM规则",
      ...
      form: {
        sourceSubUrl: "",
        clientType: "",
        customBackend: this.getUrlParam() == "" ? "https://apisub.arick.top" : this.getUrlParam(),
